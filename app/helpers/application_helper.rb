module ApplicationHelper
  def distance_of_time_in_words_to_now(to_time = 0, include_seconds = true, options = {})
  ...
  def distance_of_time_in_words(from_time, to_time = 0, include_seconds = true, options = {})
    ...
    I18n.with_options :locale => options[:locale], :scope => :'datetime.distance_in_words' do |locale|
      case distance_in_minutes
        ...
        when 90..1439 then
          locale.t :x_hours, :count => (distance_in_minutes.to_f / 60.0).round
        when 1440..2519 then
          locale.t :x_days, :count => 1
        when 2520..43199 then
